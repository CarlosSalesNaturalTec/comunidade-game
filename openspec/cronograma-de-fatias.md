...
| 15    | Desafio extra na gestão                            | `desafio-extra-na-gestao` — `RF-02-27`, `RF-02-28`, `RF-02-106`, `RN-02-10`, `RN-02-11`; a publicação traz a reserva e o encerramento pelo Admin traz a liberação da recompensa (`RF-07-39`, `RF-07-40`) — a trava caiu com a fatia 1 do PRD-14; o `RF-02-106` e as rotas do encerramento entram no PRD-02 por decisão do fundador de 2026-09-02 | em andamento |
