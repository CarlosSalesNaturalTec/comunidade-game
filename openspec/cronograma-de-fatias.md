...
| 5     | Transparência, termos e histórico de acessos  | `RF-13-29` a `RF-13-34`, `RN-13-19` — trava resolvida: texto do termo aprovado pelo fundador em 2026-09-01 | em andamento |
| 6     | Atendimento assistido, propostas e avisos     | `RF-13-35` a `RF-13-42`, `RN-13-15` a `RN-13-18` — `RF-13-37` já atendido pelo anexo do termo de biometria | em andamento |
