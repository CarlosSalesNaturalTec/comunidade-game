...
| —     | Entregas confirmadas                               | `solicitacoes-do-responsavel-e-entregas-na-gestao` — `RF-02-50`, `RF-02-51`, `RN-02-17`            | em andamento |
| 13    | Aviso de coleta e direitos na gestão               | `aviso-de-coleta-e-direitos-na-gestao` — `RF-02-64`, `RN-02-23`, `RN-02-24`                        | implementado |
| 14    | Fila de solicitações do responsável                | `solicitacoes-do-responsavel-e-entregas-na-gestao` — `RF-02-23`, `RF-02-24`, `RF-02-66`; traz também o núcleo da solicitação | em andamento |
