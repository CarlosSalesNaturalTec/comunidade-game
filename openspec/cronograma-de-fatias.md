...
| 7     | Acompanhamento e favoritos                       | `RF-14-48` a `RF-14-55`, `RN-14-23` a `RN-14-25`; entidade `Favorito` (PRD-14 §8) — a leitura pública que a tela consome já é do núcleo; ficam de fora, por dependerem de PRD que ainda não entrou, o quinto fato da novidade do `RF-14-53` (resultado de batalha, PRD-10) e a página pública de onde se favorita o Mestre do `RF-14-52` (PRD-03) | em aberto |
