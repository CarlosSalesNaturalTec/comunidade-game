...
| 19    | Imagem da pergunta do desbloqueio                | `RF-09-119`: imagem opcional por pergunta, até 1 MB cada, nos formatos de imagem da lista fechada do upload, no padrão de envio do conteúdo da missão. Depende da fatia 18 | em aberto |
