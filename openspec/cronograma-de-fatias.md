...
| 16    | Vitrine institucional e Apoiador na gestão         | `RF-02-80`, `RF-02-85`, `RF-02-101` — depende do PRD-14 (cadastro de Apoiador) e do PRD-03 (vitrine); leva também a fila dos documentos comprobatórios pendentes e a tela da anexação (`RF-02-101`) — o ato no núcleo já foi entregue pela fatia 3 do PRD-14 | em aberto    |
