...
| —     | Entrada da Área do Guerreiro(a) fora do encontro | `2026-09-21-entrada-da-area-do-guerreiro-fora-do-encontro` — `RF-05-01` a `RF-05-04`, `RN-05-01`, `RN-05-02`, `RN-05-48` (nova), `RF-01-74`, `RN-01-57`, `RN-01-58` (novas): a App 05 é usada em casa, entre as aulas, e hoje **não tem entrada alguma ali** — o reconhecimento responde 422 pelo mesmo defeito da App 01, e a confirmação assistida exige um Mestre logando com Google no aparelho da criança. Passa a valer o limiar **mais frouxo dos pontos de apoio ativos da comunidade** do Guerreiro(a), e quem abre a sessão fora do encontro é o **responsável**, só a dos seus, por login social ou usuário e senha, com a troca de senha provisória resolvida no mesmo fluxo. A recusa por nick fora da sua responsabilidade é indistinguível da recusa por nick inexistente. **Tem delta de spec** em `area-do-guerreiro`, `sessao-do-guerreiro` e `template-biometrico`. **Depende** deste PR de documentação e da change da App 01 | a implementar |
