...
| 19    | Catálogo de tipos de recurso e de coleta na gestão  | `RF-02-107`, `RF-02-108`: os dois catálogos que o Admin mantém não têm tela em lugar nenhum — nascem vazios e assim ficam, e com eles ficam vazios os dois seletores da App 09, o da recompensa pelo desbloqueio e o do desafio de coleta. O núcleo já serve criar e listar os dois; a fatia é só de tela, em áreas que já existem — Recursos e Território. Editar, desativar e abrir vigência nova não têm rota e saem como pendência (decisão do fundador, 2026-09-09); `RF-07-03`, o cadastro no ato do aporte, é fatia própria — `catalogo-de-tipos-de-recurso-e-de-coleta-na-gestao` | implementado |
