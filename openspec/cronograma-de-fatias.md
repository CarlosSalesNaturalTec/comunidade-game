...
| 8     | Equipe da trilha formada e homologada no encontro    | `RF-04-61`, `RF-04-62` — `RN-04-17` e `RN-04-22` são regras da partida, atendidas nas fatias 6 e 7 | em andamento |
| 9     | Entrega da produção da missão e devolutiva           | `RF-04-45` a `RF-04-47`, `RN-04-31` — mesma change da fatia 8                    | em andamento |
