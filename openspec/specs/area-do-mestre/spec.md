...
de desbloqueio**, ou a **sondagem**, em leitura — com a **imagem** que a pergunta do quiz
tiver, e não só o enunciado e as alternativas. Conteúdo cujo envio não foi concluído SHALL ser
dito pendente, nunca apresentado como quebrado. A pré-visualização NEVER SHALL apresentar menos
do que o Guerreiro(a) verá naquela missão. (`RF-09-25`, `RF-09-14`, `RF-09-15`, `RF-09-21`,
...
- **WHEN** o Mestre percorre a área do próprio perfil
- **THEN** não lhe é oferecido campo algum para alterar nome, e-mail ou papel — a área alcança
  apenas os artefatos comprobatórios e a identidade (nick e avatar) do próprio Mestre
