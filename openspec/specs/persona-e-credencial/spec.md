...
2. A **recusa de gravação** do cadastro do Guerreiro(a) no encontro, que SHALL devolver, no
   ...
   recusada, e o núcleo NEVER SHALL expor rota de **consulta** com esse alcance. O que sobra de
   oráculo exige, cumulativamente, a chave da App 01, sessão de trabalho aberta, aula agendada
   vigente e Mestre ou Admin autenticado no encontro — é a presencialidade pagando o que a rota
   pública não pode pagar. (`RF-04-08`, `RN-04-05`)
