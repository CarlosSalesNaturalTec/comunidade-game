...
em sessão. Cada aporte SHALL sair com a **data**, o **nome do tipo de recurso**, o **destino** e
o valor **em moedas**, e o Poder Sustentador SHALL sair como **total acumulado em moedas**. A
declaração ainda pendente NÃO SHALL aparecer nesta rota: enquanto não homologada ela não é
aporte, e é lida na rota da situação das declarações. A leitura SHALL ser somente de consulta:
esta capacidade NÃO SHALL expor rota de escrita sobre aporte algum. O valor de origem em
**reais** SHALL ficar fora da resposta — o acesso a ele é da gestão (PRD-07 §11). (`RF-07-17`,
`RN-07-05`, `RF-01-16`, `RF-14-21`, `RF-14-22`, `RF-14-23`, `RN-14-09`, PRD-07 §§9, 11, PRD-14
§6.3)
