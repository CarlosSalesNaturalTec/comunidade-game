...
- [ ] 1.1 `coletas/regra.py` e `coletas/rotas.py`: `GET /v1/tipos-de-coleta`, paginada, com nome,
...
- [ ] 1.2 `trilhas/rotas.py`: aninhar os desafios de coleta em cada missão da saída de
...
- [ ] 1.3 `fila/regra.py` e `fila/rotas.py`: `GET /v1/sugestoes/minhas`, do autor em sessão,
...
- [ ] 2.1 `apps/app-09-mestre/src/trilhas/api.ts`: tipos e chamadas de `GET /v1/tipos-de-coleta`,
...
- [ ] 2.2 `trilhas/FormularioDeDesafioDeColeta.tsx`: tipo escolhido entre os **ativos** do
...
- [ ] 2.3 `trilhas/ListaDeMissoes.tsx` e `trilhas/TelaDaTrilha.tsx`: apresentar os desafios já
...
- [ ] 3.1 `apps/app-09-mestre/src/territorio/api.ts`: lista pública de comunidades, solicitações
...
- [ ] 3.2 `territorio/TelaDeTerritorio.tsx` e `territorio/AvaliacaoDeSolicitacao.tsx`:
...
- [ ] 3.3 `apps/app-09-mestre/src/propostas/api.ts` e `propostas/TelaDePropostas.tsx`: registro
...
- [ ] 3.4 `App.tsx`: as áreas "Território" e "Propostas" na navegação, com o contador do alerta
      na primeira enquanto houver solicitação em aberto, some quando a última é tratada
      (`RF-09-54`).

## 4. Testes das telas

- [ ] 4.1 `apps/app-09-mestre/src/trilhas/trilhas.test.tsx`: os cenários de "O Mestre declara o
...
- [ ] 4.2 `apps/app-09-mestre/src/territorio/territorio.test.tsx`: os cenários de "O Mestre
      ...
      comunidade.
- [ ] 4.3 `apps/app-09-mestre/src/propostas/propostas.test.tsx`: os cenários de "O Mestre
...
- [ ] 5.1 `openspec/cronograma-de-fatias.md`: marcar as fatias **7** e **8** do PRD-09 como
