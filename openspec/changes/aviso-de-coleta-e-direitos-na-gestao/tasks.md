...
- [ ] 1.1 Criar `apps/app-03-gestao/src/direitos/AvisoDeColeta.tsx`: aviso discreto
...
- [ ] 1.2 Criar `apps/app-03-gestao/src/direitos/TelaDeDireitos.tsx` com a tabela do PRD-02 §11
...
- [ ] 1.3 Registrar a área `direitos` em `apps/app-03-gestao/src/App.tsx` — chave, rótulo
      "Direitos e dados" e navegação —, e ligar o acesso do aviso a ela (`RF-02-64`).

## 2. O aviso nas telas que gravam dado pessoal

- [ ] 2.1 Pôr o aviso nos cadastros de `apps/app-03-gestao/src/personas/`:
      ...
      §11 (`RF-02-64`).
- [ ] 2.2 Pôr o aviso em `apps/app-03-gestao/src/lancamentos/`: `ConferenciaDePresencas`,
...
- [ ] 2.3 Pôr o aviso em `apps/app-03-gestao/src/painel-do-dia/AnexoDaDigitalizacao.tsx`, sobre
      o termo assinado no encontro (`RF-02-64`).
- [ ] 2.4 Pôr o aviso em `apps/app-03-gestao/src/filas/AvaliacaoDaSolicitacao.tsx` e
...
- [ ] 3.1 Conferir e assegurar em `apps/app-03-gestao/src/lancamentos/` que a lista é a do
...
- [ ] 3.2 Acrescentar em `apps/app-03-gestao/src/atividades/TelaDeAtividades.tsx` a linha que
...
- [ ] 4.1 `apps/app-03-gestao/src/direitos/direitos.test.tsx`: a área apresenta o destino de
...
- [ ] 4.2 Estender `personas.test.tsx`, `lancamentos.test.tsx`, `painel-do-dia.test.tsx` e
...
- [ ] 4.3 Em `lancamentos.test.tsx`, cobrir o `RN-02-23`: Guerreiro(a) cujo responsável recusou
      ...
      (`RN-02-23`).
- [ ] 4.4 Em `atividades.test.tsx` e `territorio.test.tsx`, cobrir o `RN-02-24`: a área
...
- [ ] 5.1 `openspec/cronograma-de-fatias.md`: o recorte já foi corrigido ao abrir a change —
      resta marcar a fatia 13 do PRD-02 como `implementado` ao arquivar.
- [ ] 5.2 `docs/09-topicos-em-aberto-e-sugestoes.md`: gravar a decisão do fundador —
...
- [ ] 5.3 `docs/prds/prd-02-frontend-de-gestao.md`: a §3.2 recebe a exclusão dos recortes de
...
- [ ] 5.4 `docs/prds/index.md`: atualizar a coluna de situação do PRD-02 e do PRD-09 se a
