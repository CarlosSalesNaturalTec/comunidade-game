...
- [ ] 1.1 `RF-05-19`: acrescentar em `trilhas/regra.py` a derivação dos desafios em aberto do
...
- [ ] 1.2 `RF-05-22`, `RF-05-24`: acrescentar em `equipes/regra.py` a consulta das equipes de
...
- [ ] 1.3 `RF-05-22`: acrescentar em `equipes/regra.py` a derivação das atividades de cada
...
- [ ] 2.1 `RF-05-19`, `RN-05-21`: expor `GET /v1/eu/desafios` em `trilhas/rotas.py`, com
...
- [ ] 2.2 `RF-05-22`, `RF-05-23`, `RN-05-15`: expor `GET /v1/eu/equipes` em `equipes/rotas.py`,
...
- [ ] 3.1 `RF-05-19`: criar `tests/test_meus_desafios.py` cobrindo os cenários da spec de
...
- [ ] 3.2 `RF-05-22`, `RF-05-23`, `RF-05-24`: criar `tests/test_minhas_equipes.py` cobrindo os
...
- [ ] 4.1 `RF-05-19`, `RF-05-22`: criar `src/api/desafiosEEquipes.ts` com os dois clientes de
      leitura e os tipos das duas saídas, no molde de `src/api/trilha.ts`.
- [ ] 4.2 `RF-05-19`, `RN-05-06`: criar `src/desafios/MeusDesafios.tsx` — cada desafio com
...
- [ ] 4.3 `RF-05-22`, `RF-05-23`, `RF-05-24`: criar `src/desafios/MinhasEquipes.tsx` — as
...
- [ ] 4.4 `RF-05-19`, `RF-05-22`: criar `src/desafios/DesafiosEEquipes.tsx` com as duas abas, no
      molde de `Carteira.tsx`, e ligá-lo como bloco novo na navegação de `AreaDoGuerreiro.tsx`
      (design — decisão 6).
- [ ] 4.5 `RF-05-19`, `RF-05-22`, `RF-05-23`, `RN-05-22`: escrever os testes dos três
...
- [ ] 5.1 Marcar a fatia 6 do PRD-05 como implementada em
