...
## 0. Destravar antes de seguir

- [ ] 0.1 Obter do fundador as **imagens de comunidade** e a regra de uso delas — acervo do projeto,
      foto da comunidade registrada na plataforma ou ilustração no traço do documento 15 §2 —,
      registrando a decisão no documento-fonte e no documento 09. Bloqueia a tarefa 2.
- [ ] 0.2 Obter do fundador **quais fatos ganham retorno** entre missão desbloqueada, badge
      certificado, nível que subiu, ponto creditado e produção entregue. É decisão de gamificação, do
      documento 11. Bloqueia a tarefa 3.
...
## 2. Imagem de comunidade ao fundo — bloqueada pela tarefa 0.1
...
## 3. Retorno de progresso e conquista — bloqueada pela tarefa 0.2
...
- [ ] 4.2 Registrar no documento 09 §1 as duas travas enquanto não decididas e, decididas, gravar
      cada uma no documento-fonte dela — a imagem de comunidade no documento 15 §6, os fatos que
      ganham retorno no documento 11. Nada muda em `docs/prds/index.md`, no documento 99 nem na `nav`
