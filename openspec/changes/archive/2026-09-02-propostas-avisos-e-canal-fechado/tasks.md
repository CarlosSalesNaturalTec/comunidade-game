...
- [x] 1.1 Criar `apps/app-08-apoiador/src/direitos/ContextoDeDireitos.tsx` com o provedor e o
      `useDireitos`, no mesmo desenho das Apps 03 e 09, e verificar que o `useDireitos` fora do
      provedor lança erro (`RF-14-58`)
- [x] 1.2 Criar `apps/app-08-apoiador/src/direitos/TelaDeDireitos.tsx` de leitura, com a tabela
...
- [x] 1.3 Criar `apps/app-08-apoiador/src/direitos/AvisoDeColeta.tsx`, com `role="status"`, que
...
- [x] 2.1 Criar `apps/app-08-apoiador/src/propostas/api.ts` com `registrarProposta`
...
- [x] 2.2 Criar `apps/app-08-apoiador/src/propostas/TelaDePropostas.tsx` com o registro em
...
- [x] 3.1 Em `apps/app-08-apoiador/src/App.tsx`, envolver a árvore com sessão e a sem sessão no
...
- [x] 3.2 Acrescentar o `AvisoDeColeta`, nomeando o dado de cada tela, às nove telas que gravam
...
- [x] 4.1 `apps/app-08-apoiador/src/direitos/direitos.test.tsx`: a área lista destino e uso de
...
- [x] 4.2 `apps/app-08-apoiador/src/propostas/propostas.test.tsx`: a proposta entra na fila
      ...
      `RN-14-27`)
- [x] 4.3 `apps/app-08-apoiador/src/testes/canalFechado.test.tsx`: renderiza as telas da
      ...
      `RN-14-20`, `RN-14-24`)
- [x] 4.4 `apps/app-08-apoiador/src/preCadastro/preCadastro.test.tsx`: a porta pública traz o
      aviso e alcança a área detalhada sem sessão (`RF-14-58`)

## 5. Documentação

- [x] 5.1 Marcar a fatia 8 do PRD-14 como implementada em `openspec/cronograma-de-fatias.md`,
