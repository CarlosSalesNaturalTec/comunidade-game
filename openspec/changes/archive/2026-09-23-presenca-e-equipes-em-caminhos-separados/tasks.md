...
- [x] 1.1 `RF-04-68`, `RN-04-40`: criar `GET /v1/aulas/{id}/presencas/eu` em
...
- [x] 2.1 `RF-04-68`, `RN-04-40`: acrescentar em `backend/src/nucleo/erros.py` a recusa 422 com
...
- [x] 2.2 `RF-04-68`, `RN-04-40`: em `backend/src/nucleo/equipes/regra.py`, `criar_equipe` (com
...
- [x] 3.1 `RF-04-68`: testes da leitura da presença própria — tem presença, não tem, presença
      anulada lida como ausência, leitura sempre da própria persona e aula inexistente em 404
      (cenários da spec `aula-e-presenca`).
- [x] 3.2 `RF-04-68`, `RN-04-40`: testes da guarda em `backend/tests/test_equipe_rota.py` e
...
- [x] 4.1 `RF-04-68`: em `apps/app-01-aula-presencial/src/api/presencas.ts`, a leitura da
      presença do Guerreiro(a) em sessão na aula em curso. Verificação: usada em 4.3 e coberta
      pelos testes da tarefa 5.
- [x] 4.2 `RF-04-67`, `RF-04-18`, `RF-04-21`: `TelaDeEntradaDoGuerreiro` passa a receber o
      ...
      tarefa 5.1 passam.
- [x] 4.3 `RF-04-01`, `RF-04-67`, `RF-04-68`, `RN-04-40`: `TelaInicial` passa a oferecer
...
- [x] 5.1 `RF-04-67`, `RF-04-18`, `RF-04-21`: em `entrada/entrada.test.tsx`, o caminho
...
- [x] 5.2 `RF-04-01`, `RF-04-67`, `RF-04-68`: em `inicio/inicio.test.tsx`, os três caminhos na
...
- [x] 5.3 Ajustar os testes que hoje entram pelas equipes pelo caminho antigo —
...
- [x] 6.1 Decisão nova do fundador de 2026-09-23 (quiz e troca também exigem presença):
...
- [x] 6.2 Marcar a fatia 18 do PRD-04 como implementada em
