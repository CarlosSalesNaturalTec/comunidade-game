...
- [x] 1.1 Em `.github/workflows/backend-deploy.yml`, declarar
...
- [x] 2.1 Fazer o arranque recusar, com mensagem nomeando a variável e o ambiente, quando
...
- [x] 3.1 Em `backend/tests/test_armazenamento_porta.py` (novo), cobrir o adaptador de nuvem,
...
- [x] 4.1 Em `backend/README.md`: remover a frase que afirma o fallback para disco local, que é
...
- [x] 4.2 Registrar a change em `openspec/cronograma-de-fatias.md`: linha sem número no bloco
