...
A produção da missão é o que a equipe entrega depois de trabalhar a atividade do encontro —
por texto, fala ou foto do manuscrito — e a devolutiva construtiva que a plataforma lê de
volta, sem creditar ponto algum e sem guardar a foto nem o áudio.
...
aparecer em resposta alguma. (`RF-04-46`, documento 03 §12.2, PRD-04 §11)
...
próximo passo em vez do erro. A devolutiva SHALL ser gravada com a produção.
...
**Mestre**. (`RF-04-47`, documento 11 §§2.2, 5, documento 99 §6 invariante 19)
...
- Entrega por **texto**: a transcrição é o próprio texto e não depende de leitura alguma. Se a
  ...
  gravar a produção assim mesmo, com a **devolutiva em branco**, e responder **201**. O que a
  equipe escreveu NEVER SHALL se perder por indisponibilidade do modelo.
- Entrega por **áudio** ou **foto**: sem leitura não há transcrição, e gravar o registro vazio
  seria guardar uma entrega que não diz nada. O núcleo SHALL responder **503**, sem gravar, para
  a equipe reenviar.
