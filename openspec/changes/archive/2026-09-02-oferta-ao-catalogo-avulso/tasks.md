...
- [x] 1.1 Em `backend/src/nucleo/catalogo_avulso/regra.py`, acrescentar `listar_ofertas_do_apoiador`,
...
- [x] 1.2 Em `backend/src/nucleo/catalogo_avulso/rotas.py`, acrescentar `GET /v1/eu/catalogo-avulso`
...
- [x] 2.1 Criar `apps/app-08-apoiador/src/catalogoAvulso/api.ts` com `ofertarItem`
      (`POST /v1/catalogo-avulso`, sem campo de preço) e `listarMinhasOfertas`
      (`GET /v1/eu/catalogo-avulso`) (`RF-14-77`, `RF-14-79`, `RF-14-80`)
- [x] 2.2 Criar `apps/app-08-apoiador/src/catalogoAvulso/TelaDeOferta.tsx` com nome, tipo de
...
- [x] 2.3 Criar `apps/app-08-apoiador/src/catalogoAvulso/TelaDeMinhasOfertas.tsx` com a situação
...
- [x] 2.4 Em `apps/app-08-apoiador/src/App.tsx`, acrescentar as áreas "Ofertar item" e
      "Minhas ofertas" à navegação, verificando pela navegação renderizada (`RF-14-77`,
      `RF-14-80`, design — decisão 5)

## 3. Testes

- [x] 3.1 Em `backend/tests/test_catalogo_avulso.py`, cobrir a rota nova: o item pendente, o
      ...
      `RN-14-42`, `RN-14-43`)
- [x] 3.2 Em `backend/tests/test_catalogo_avulso.py`, cobrir a contagem de trocas: item sem troca
...
- [x] 3.3 Criar `apps/app-08-apoiador/src/catalogoAvulso/catalogoAvulso.test.tsx`: a tela de
...
- [x] 4.1 Marcar a fatia 9 como implementada em `openspec/cronograma-de-fatias.md`, com o slug da
