...
- [x] 1.1 `recursos/regra.py::listar_tipos_de_recurso` e o docstring de
...
- [x] 2.1 `apps/app-09-mestre/src/recursos/api.ts`: tipos e chamadas de
...
- [x] 2.2 `recursos/ListaDeNecessidades.tsx`: a falta de cada aula com tipo, quantidade, valor em
...
- [x] 2.3 `recursos/AbsorcaoDaNecessidade.tsx`: o ato de confirmação a partir da linha escolhida
      ...
      `RN-09-13`, `RN-09-16`).
- [x] 2.4 `recursos/MinhasAbsorcoes.tsx`: as absorções do próprio Mestre com tipo, quantidade,
...
- [x] 2.5 `recursos/TelaDeRecursos.tsx` e `App.tsx`: a área "Recursos" na navegação, reunindo as
...
- [x] 3.1 `apps/app-09-mestre/src/recursos/recursos.test.tsx`: os cenários de "A App 09 apresenta
...
- [x] 3.2 `apps/app-09-mestre/src/recursos/ressarcimento.test.tsx`: os cenários de "O Mestre
...
- [x] 4.1 `openspec/cronograma-de-fatias.md`: marcar a fatia **9** do PRD-09 como implementada,
