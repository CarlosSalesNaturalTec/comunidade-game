...
- [x] 1.1 `RF-09-14`, `RF-09-15`: em `backend/src/nucleo/trilhas/rotas.py`,
...
- [x] 1.2 `RF-09-21`: na mesma rota, montar a bibliografia de cada missão com
...
- [x] 1.3 `RF-09-22`, `RF-09-23`: confirmar que, com `ponto_de_apoio_id=None`, a entrada
...
- [x] 2.1 `RF-09-14`, `RF-09-15`, `RF-09-21`: em `apps/app-09-mestre/src/trilhas/api.ts`,
...
- [x] 2.2 `RF-09-14`, `RF-09-15`: verificar que `ListaDeMissoes.tsx` e
...
- [x] 2.3 `RF-09-21`, `RF-09-22`, `RF-09-23`: em `Bibliografia.tsx`, trocar o ternário
...
- [x] 3.1 `backend/tests/test_trilha_rota.py`: `GET /v1/trilhas/minhas` devolve o conteúdo
      ...
      delta.
- [x] 3.2 `apps/app-09-mestre/src/trilhas/trilhas.test.tsx`: a tela reabre conteúdo e
...
- [x] 4.1 Marcar a linha desta change como `implementado` em
