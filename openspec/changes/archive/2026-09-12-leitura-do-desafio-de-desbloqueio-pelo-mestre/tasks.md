...
- [x] 1.1 `RF-09-26`, `RF-09-118`, `RF-09-119`: em `backend/src/nucleo/trilhas/rotas.py`,
...
- [x] 1.2 `RF-09-118`: ler as perguntas de todas as missões da trilha em uma consulta por
...
- [x] 2.1 `RF-09-26`, `RF-09-118`, `RF-09-119`: em `apps/app-09-mestre/src/trilhas/api.ts`,
...
- [x] 2.2 `RF-09-26`, `RF-09-118`: em `DesafioDeDesbloqueio.tsx`, o formulário nasce do que a
...
- [x] 2.3 `RF-09-118`: em `ListaDeMissoes.tsx`, o resumo da linha passa a refletir o desafio que
...
- [x] 3.1 `RF-09-119`: exibir a imagem da pergunta em `DesafioDeDesbloqueio.tsx` pelo padrão da
...
- [x] 4.1 `RF-09-81`, `RN-09-30`, `RN-05-46`: quando a missão é sondagem, `ListaDeMissoes.tsx`
...
- [x] 5.1 `backend/tests/test_trilha_rota.py`: a leitura das trilhas próprias devolve o quiz com
...
- [x] 5.2 `apps/app-09-mestre/src/trilhas/trilhas.test.tsx`: a tela reabre o quiz e o prático
...
- [x] 6.1 Marcar a linha desta change como `implementado` em
