...
### Requirement: O registro guarda a origem, e o sensor não é alcançável nesta entrega

O núcleo SHALL gravar em cada registro a sua **origem**. As origens SHALL ser **manual**, **voz**
e **sensor**. Nesta entrega, a rota autenticada por sessão de Guerreiro(a) SHALL aceitar apenas
as origens `manual` e `voz`; a origem **`sensor`** SHALL exigir credencial de dispositivo e SHALL
ser recusada com **422** enquanto essa credencial não existir — ela é `RF-08-14`, `RF-01-67` e
`RF-01-68`, de entrega posterior. (`RF-08-08`, `RN-08-23`, PRD-08 §8)
