...
- [ ] 1.1 Declarar em `backend/src/nucleo/biometria/regra.py` a constante da dimensão do
...
- [ ] 1.2 Remover `biometria_dimensao_do_descritor` de `backend/src/nucleo/configuracao.py` e a
      ...
      decisão 3).
- [ ] 1.3 Fazer as fixtures do backend usarem a **constante do núcleo** no lugar da dimensão
...
- [ ] 1.4 Cobrir em `backend/tests/test_biometria.py` os cenários do delta de
...
- [ ] 2.1 Fazer `apps/app-01-aula-presencial/src/onboarding/TelaDeCaptura.tsx` apresentar
      ...
      decisão 4).
- [ ] 2.2 Cobrir em `apps/app-01-aula-presencial/src/onboarding/captura.test.tsx` os três
