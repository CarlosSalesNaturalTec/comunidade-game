...
- [ ] 1.1 `RF-09-29`, `RF-09-30`, `RF-09-04`: acrescentar `culminancia: CulminanciaSaida | None`
...
- [ ] 2.1 `RF-09-16`, `RF-09-17`, `RF-09-115`: acrescentar a coluna do tipo do arquivo a
...
- [ ] 2.2 `RF-09-16`, `RF-09-17`: escrever a revisão Alembic da coluna nova em
...
- [ ] 2.3 `RF-05-11`, `RF-09-25`, `RN-01-28`: escrever a regra de leitura dos bytes em
...
- [ ] 2.4 `RF-05-11`, `RF-09-25`: expor `GET /v1/conteudos/{id}/arquivo` em
...
- [ ] 3.1 `RF-09-29`, `RF-09-30`: em `apps/app-09-mestre/src/trilhas/api.ts`, tipar
...
- [ ] 3.2 `RF-09-29`, `RF-09-30`, `RF-09-06`, `RF-09-07`: em `TelaDaTrilha.tsx`, fazer o resumo,
...
- [ ] 3.3 `RF-09-14` a `RF-09-17`, `RF-09-25`: acrescentar à camada de acesso da App 09 a
      ...
      teste da tarefa 5.3.
- [ ] 3.4 `RF-09-25`, `RF-09-14`, `RF-09-15`, `RF-09-21`, `RF-09-26`, `RF-09-81`: reescrever
...
- [ ] 3.5 `RF-09-25`, `RF-09-114`: passar a `PreVisualizacaoDaMissao`, a partir de
...
- [ ] 4.1 `RF-05-11`: em `apps/app-05-guerreiro/src/api/trilha.ts`, acrescentar a leitura do
      arquivo do conteúdo como _blob_, pela rota nova e com a chave de aplicação. Verificar pelo
      teste da tarefa 5.4.
- [ ] 4.2 `RF-05-11`, `RF-05-12`: em `trilha/Missao.tsx`, substituir `conteudoLegivel`, que hoje
...
- [ ] 5.1 `backend/tests/test_trilha_rota.py` e `test_culminancia.py`: a leitura das trilhas
...
- [ ] 5.2 `backend/tests/` do conteúdo: a confirmação grava o tipo apurado; os bytes são
...
- [ ] 5.3 `apps/app-09-mestre/src/trilhas/trilhas.test.tsx`: a culminância gravada reabre em
...
- [ ] 5.4 `apps/app-05-guerreiro/src/trilha/Missao.test.tsx`: a imagem do conteúdo aparece como
...
- [ ] 6.1 Acrescentar `GET /v1/conteudos/{id}/arquivo` à tabela de contrato de API do PRD-09 §9,
