...
- [ ] 1.1 Em `apps/app-01-aula-presencial/src/inicio/inicio.test.tsx`, trocar o marcador de tela
...
- [ ] 2.1 Em `apps/app-01-aula-presencial/src/entrada/TelaDeEntradaDoGuerreiro.tsx`, declarar o
...
- [ ] 2.2 Usar o mapa no `Cabecalho` da tela de confirmação por PIN e no da tela de
...
- [ ] 3.1 Em `inicio.test.tsx`, cobrir a entrada pelos caminhos das equipes, do quiz e da troca,
      ...
      `RF-04-67`, `RF-04-68`).
- [ ] 3.2 Em `apps/app-01-aula-presencial/src/entrada/entrada.test.tsx`, conferir que as
...
- [ ] 4.1 Acrescentar ao bloco do PRD-04 em `openspec/cronograma-de-fatias.md` a linha `—` desta
