...
- [ ] 1.1 `RF-05-01`, `RN-05-01`, `RN-01-57` — em
...
- [ ] 2.1 `RN-05-48`, `RF-01-27` — em
      ...
      recusa.
- [ ] 2.2 `RN-05-48` — encerrar o tratamento da recusa na conferência e dar tratamento próprio
...
- [ ] 3.1 `RF-05-03`, `RF-05-04`, `RN-05-02` — em
...
- [ ] 3.2 `RF-01-12`, `RF-14-09` — conduzir a **troca de senha provisória** dentro do próprio
      ...
      caminho.
- [ ] 3.3 `RN-01-58`, `RN-01-22` — apresentar a recusa por criança fora da responsabilidade de
...
- [ ] 3.4 `RN-05-02` — conferir que a sessão do adulto continua morrendo assim que a da criança
      abre, com a chave de armazenamento própria que já existe, inclusive nos caminhos novos.

## 4. Testes

- [ ] 4.1 `RF-05-01`, `RN-01-57` — em `apps/app-05-guerreiro/src/entrada/entrada.test.tsx`,
      cobrir "A conferência é submetida sem aula".
- [ ] 4.2 `RN-05-48`, `RF-01-27` — cobrir "Erro de validação não vira rosto que não confere",
      "Rede fora não vira rosto que não confere" e "Nenhum código técnico chega à criança na
      falha de camada".
- [ ] 4.3 `RF-05-03`, `RF-05-04`, `RF-01-12` — cobrir "Em casa, quem confirma é o responsável",
      "O responsável entra pelos dois caminhos de login" e "Senha provisória se troca ali mesmo".
- [ ] 4.4 `RN-01-58`, `RN-05-02` — cobrir "Criança alheia recusa com a frase de sempre" e
