...
- [ ] 1.1 Criar `apps/app-03-gestao/src/acervo/api.ts` com o tombamento
...
- [ ] 1.2 Criar `apps/app-03-gestao/src/acervo/TelaDoAcervo.tsx`: seletor de comunidade no padrão
...
- [ ] 1.3 Ligar a área **Acervo** à navegação do `App.tsx`, entre Pontos de Apoio e Agenda
      (`RF-02-52`).

## 2. App 03 — exemplar, ficha de vida e anotação

- [ ] 2.1 Criar `ListaDoAcervo.tsx` e `Acervo.css`: lista densa com título, número de tombo,
...
- [ ] 2.2 Criar `FormularioDeTombamento.tsx`, oferecido só ao Admin: título, número de tombo,
...
- [ ] 2.3 Criar `FichaDeVida.tsx`: seção do exemplar, aberta e fechada por item, com as anotações
      ...
      decisão 2).
- [ ] 2.4 Criar `AnotacaoNaFichaDeVida.tsx`, oferecida ao Admin e ao Mestre: teor em escolha
...
- [ ] 3.1 Em `apps/app-03-gestao/src/pontos-de-apoio/api.ts`, acrescentar a designação
      (`PUT /v1/pontos-de-apoio/{id}/responsavel`) (`RF-02-52`, `RF-07-49`).
- [ ] 3.2 Criar `pontos-de-apoio/DesignarResponsavel.tsx`, oferecido só ao Admin, com os Mestres
...
- [ ] 3.3 Em `ListaDePontosDeApoio.tsx`, trocar o rótulo "Responsável designado" pelo **nome** do
      designado, mantendo a ausência como informação, e ligar o caminho da designação
      (`RF-02-52`, `RN-07-34`; design — decisão 3).

## 4. Testes

- [ ] 4.1 `apps/app-03-gestao/src/acervo/acervo.test.tsx` — acervo: a lista com os quatro campos e
      ...
      `RN-02-19`).
- [ ] 4.2 No mesmo arquivo — ficha de vida: as anotações em ordem do tempo com teor, estado,
...
- [ ] 4.3 Em `apps/app-03-gestao/src/pontos-de-apoio/pontos-de-apoio.test.tsx` — a designação de
...
- [ ] 5.1 Em `openspec/cronograma-de-fatias.md`, marcar a fatia 12 como implementada com o slug
