...
- [ ] 1.1 Acrescentar em `.firebaserc`, no mapa do projeto `comunidade-game-506017`, os alvos
...
- [ ] 2.1 Criar `.github/workflows/app-07-deploy.yml`, espelho de `app-05-deploy.yml`:
...
- [ ] 2.2 No mesmo arquivo, o passo de build em `apps/app-07-responsaveis` com
...
- [ ] 2.3 No mesmo arquivo, autenticação por `google-github-actions/auth@v2` com
...
- [ ] 3.1 Criar `.github/workflows/app-08-deploy.yml` pelas mesmas três tarefas do grupo 2,
...
- [ ] 4.1 Reescrever a seção **Implantação** do `apps/app-07-responsaveis/README.md` e do
      ...
      implantada".
- [ ] 4.2 Acrescentar a linha desta change à tabela **Infraestrutura transversal (sem PRD)**
