...
- [ ] 1.1 `RF-04-18`, `RF-01-73` — acrescentar `aula_id` à entrada de
...
- [ ] 2.1 `RN-04-36`, `RF-01-27` — em `TelaDeEntradaDoGuerreiro.tsx`, reconhecer a recusa da
      ...
      código.
- [ ] 2.2 `RN-04-36`, `RF-01-27` — apresentar a falha de camada pelo que ela é: a `mensagem` do
...
- [ ] 2.3 `RN-04-36`, `RF-04-18` — encerrar o tratamento da conferência na abertura da sessão e
...
- [ ] 2.4 `RF-04-64`, `RN-04-34` — conferir que o retorno do laço continua calando em **todos**
...
- [ ] 3.1 `RF-04-18`, `RF-01-73` — em `apps/app-01-aula-presencial/src/entrada/entrada.test.tsx`,
...
- [ ] 3.2 `RN-04-36`, `RF-01-27` — cobrir "Erro de validação não se disfarça de rosto que não
...
- [ ] 3.3 `RF-04-20`, `RN-01-22`, `RN-01-56` — conferir que os cenários já existentes da recusa
...
- [ ] 4.1 Marcar a linha desta change como implementada em `openspec/cronograma-de-fatias.md`.
