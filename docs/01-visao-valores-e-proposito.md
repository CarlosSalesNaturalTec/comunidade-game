...
Inegociáveis, devem permear conteúdos, regras do jogo, comunicação e governança:
...
5. **Reconhecimento dos povos originários/indígenas brasileiros** — seus saberes, histórias
   e presença viva no território.
6. **Território e identidade** — a comunidade não é cenário, é protagonista. Cada Comunidade
...
atividades ligadas às causas e pontuação negativa por violação do código de conduta.
...
contra mulheres, identidade, povos originários, sustentabilidade, convivência e cidadania.
...
- Contato inicial com programação e robótica **sem exigir um computador** (material
  reciclado, kits, atividades presenciais e Web App acessível pelo celular).
- Abordagem **lúdica e experimental**, em ambiente **"sem miséria"** — na expressão baiana:
  fartura, bem-estar, ambiente agradável, alimentos em abundância.
...
construção dos primeiros artefatos do ecossistema digital: backend, aplicações, trilhas e a
narrativa do jogo.
...
Mestre da plataforma. A regra vale para o fundador como vale para todos — habilidade se
comprova com trabalho publicado e verificável.

Os três papéis acumulados:

- **Primeiro Admin** da plataforma. Novos Admins são incluídos manualmente por um Admin
  existente; não há autocadastro de administradores.
- **Primeiro Mestre**, responsável pelos poderes de **Programação e Robótica**, com
  habilidade comprovada pelo próprio software da plataforma, pelas trilhas e atividades
  propostas, por videoaulas e exemplos de código. É autor das **duas primeiras trilhas**:
  **Robô Educa** e **Batalha de Laser**.
- **Responsável legal** da pessoa jurídica vinculada ao projeto — a **Robô Educa — Kits
  Robóticos Educacionais**, que recebe doações e assina termos (documento 04).
...
riscos deve dar o exemplo, dizendo abertamente onde e como a usa. Por isso a declaração de
transparência acompanha os artefatos públicos do projeto, a começar pela vitrine.
