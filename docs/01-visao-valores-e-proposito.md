...
- Estimular o **empreendedorismo e a economia criativa** nas comunidades, a partir dos
  jovens talentos impactados pela plataforma.
- **Evitar crenças limitantes** — o jovem periférico pode ocupar qualquer espaço.
- Ser **efetiva e engajadora** junto ao público-alvo (crianças e jovens).
- Ser **Open Source**, para atingir o maior número possível de escolas e comunidades
...
Estes valores são inegociáveis e devem permear conteúdos, regras do jogo, comunicação e
...
5. **Reconhecimento e valorização dos povos originários/indígenas brasileiros** — seus
   saberes, histórias e presença viva no território.
