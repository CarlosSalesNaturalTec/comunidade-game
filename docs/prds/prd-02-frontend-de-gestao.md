...
| Mestre    | Lê o painel do dia e conduz o Quiz ao Vivo das aulas que ministra                     | Escrever nas demais rotas de gestão — o que é dele fica na App 09   |
...
conduz a partida de quiz das suas aulas — nada além disso.
...
| `RF-02-86` | Admin mantém a escada de valores sugeridos, com o equivalente em moedas de cada degrau              | essencial  |
| `RF-02-87` | Pré-cadastro sem comprovante legível é recusado com motivo, sem criar cadastro nem aporte           | essencial  |
...
| `RF-02-55` | Perda ou dano gera necessidade de reposição, sem débito ao Guerreiro(a) nem à família              | essencial  |
...
| `RN-02-20` | Mestre acessa esta aplicação para ler o painel do dia e conduzir o quiz das suas aulas        | —          | 03 §5      |
...
vinculado ao encontro ou à atividade, ao Guerreiro(a) e ao motivo registrado. Correção de
...
| PUT    | `/v1/valores-sugeridos`                           | Admin           | Mantém a escada de valores sugeridos do pré-cadastro                  |
...
| `RF-02-83` a `RF-02-87` | 02 §1 e 04 §2 (pré-cadastro, comprovante e homologação)  |
