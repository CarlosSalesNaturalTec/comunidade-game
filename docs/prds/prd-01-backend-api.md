...
| Mestre       | Suas trilhas e conteúdos, lançamentos e pontuação negativa das suas atividades, condução do Quiz ao Vivo das suas aulas, auditoria de coleta, aprovação de local, aportes seus, cadastro de responsável e vínculo com Guerreiros e Guerreiras, confirmação de identidade do Guerreiro(a), cadastro biométrico dele, **medição do limiar de comparação do ponto de apoio (`RF-01-73`)**, **cadastro do Guerreiro(a) sob a sessão de trabalho do aparelho — autocadastro dele, nunca do Mestre (`RN-04-04`)**, **homologação da equipe da trilha**, **emissão e revogação da credencial de dispositivo do desafio de que é autor**, **testemunho do termo impresso** de consentimento assinado pelo responsável no encontro — distinto do consentimento que o próprio responsável dá na App 07 —, **documentos comprobatórios** da própria habilidade, propostas de evolução e **propostas de desafio extra** | O que é público, suas turmas, o **painel do dia**, a **condução do Quiz ao Vivo** na App 03 e **os Guerreiros e Guerreiras que pode vincular a um responsável**, em leitura |
| Guerreiro(a) | Seus registros de coleta, suas criações, suas sugestões, recompensas recebidas nos marcos, as **equipes que forma — a da aula e a da trilha** —, a resposta de quiz da equipe e a **solicitação de novo local**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Seus dados, as equipes da aula em andamento, a **pergunta da partida de Quiz ao Vivo** e o que é público                                                                    |
| Responsável  | Consentimentos, autorizações, solicitações e propostas e a **confirmação de identidade dos Guerreiros e Guerreiras sob a sua responsabilidade, e apenas deles (`RF-01-74`)**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Os Guerreiros e Guerreiras sob sua responsabilidade e o que é público                                                                                                       |
...
2. Um Admin avalia o pedido na App 03 (PRD-02); aprovado, o núcleo **emite a chave** — sempre
   de **produção**, e uma por solicitação aprovada — e devolve o segredo uma única vez, com o
   prazo de apresentação já contado.
...
| `RF-01-74` | Responsável abre por confirmação a sessão dos Guerreiros e Guerreiras sob a sua responsabilidade, e apenas deles                                                                                                         | essencial  |
| `RF-01-06` | Mestre ou Admin confirma a identidade do Guerreiro(a) e abre a sessão dele quando não há _template_ gravado, o reconhecimento falha ou a biometria foi recusada, com o PIN de quem confirma e registro de quem confirmou | essencial  |
| `RF-01-75` | Mestre e Admin cadastram e trocam o próprio PIN de confirmação, de 4 dígitos; o núcleo guarda só o verificador e o entrega ao aparelho da sessão de trabalho que o adulto abriu                                          | essencial  |
...
| `RN-01-57` | Fora da aula o limiar é o mais frouxo entre os pontos de apoio **ativos** da comunidade do Guerreiro(a); sem vínculo vigente, ou sem nenhum limiar medido ali, a comparação recusa                              | —          | 03 §3.3     |
| `RN-01-58` | Nick que não é de Guerreiro(a) sob a responsabilidade de quem confirma recusa de forma indistinguível de nick inexistente, no corpo e no tempo                                                                  | —          | 03 §1.1     |
| `RN-01-59` | No encontro, confirma só o adulto da sessão de trabalho, com o próprio PIN; sem PIN cadastrado, ou com PIN bloqueado, não confirma; cinco erros seguidos bloqueiam o PIN naquele aparelho até novo login Google | —          | 03 §1.1     |
...
| `RN-01-22` | O nick é chave de acompanhamento público, cedido pela família: a busca nunca o descobre nem o sugere, e a exibição pública alcança só quem tem divulgação autorizada                                            | 12         | 02 §1       |
...
| `RN-01-30` | O nick é único em toda a plataforma, insensível a caixa, alcançando Guerreiro(a), Apoiador e Mestre                                                                                                             | —          | 02 §1       |
...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Persona`                   | papel, nome, e-mail, WhatsApp opcional e avatar; o nick, a data de nascimento e o poder declarado são de quem os tem — Guerreiro(a), Apoiador e Mestre (documento 02 §1)                                                                                                                                                                                                     |
| `Credencial`                | persona, tipo (biometria, login social, usuário e senha, dispositivo), identificador, segredo (_template_ cifrado ou hash), série vinculada e trilha em que o aparelho foi construído quando é de dispositivo, criada por, troca pendente, ativa, revogada por, motivo e data da revogação                                                                                   |
...
| `SolicitacaoDeParticipacao` | nome ou razão social, e-mail, WhatsApp, pretensão, apresentação, instituição e links opcionais, nick pretendido (só na pretensão de Apoiador, reservado por 7 dias), perfil declarado — pessoa física ou jurídica, só na pretensão de Apoiador —, aporte declarado (necessidade, valor sugerido ou livre), comprovante anexado, situação, prazo, quem avaliou, parecer, data |
...
| POST   | `/v1/sessoes/guerreiro/confirmacao`                    | Mestre ou Admin | Abre a sessão do Guerreiro(a) por confirmação humana, com o PIN de quem confirma |
| PUT    | `/v1/eu/pin-de-confirmacao`                            | Mestre ou Admin | Cadastra ou troca o próprio PIN de confirmação                                   |
| GET    | `/v1/eu/pin-de-confirmacao/verificador`                | Mestre ou Admin | Entrega ao aparelho da sessão de trabalho o verificador do PIN, nunca o PIN      |
| POST   | `/v1/aulas/{id}/presencas/sem-rede`                    | Mestre ou Admin | Registra a presença confirmada sem rede pelo nick, sem abrir sessão              |
...
| Mestre e Admin autenticam o autocadastro do Guerreiro(a) pela sessão de trabalho do App 01           | 02 §1             | Cadastro do Guerreiro(a) sob a sessão de trabalho do App 01 |
| Confirmação de identidade no encontro exige o PIN de 4 dígitos de quem confirma                      | 03 §1.1           | Confirmação de identidade no encontro exige o PIN do adulto |
...
| `RN-01-57`              | 03 §3.3 (limiar emprestado fora do encontro)       |
| `RF-01-74` e `RN-01-58` | 03 §1.1 (quem abre a sessão fora do encontro)      |
| `RF-01-75` e `RN-01-59` | 03 §1.1 (PIN de confirmação do adulto)             |
...
| `RN-01-53`              | 03 §1.1 (credencial como registro do aparelho)     |
