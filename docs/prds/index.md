...
Este arquivo é um **índice**, não um histórico narrado: registra a situação de cada PRD e nada
mais. As fatias de implementação — as entregues e as que faltam, com o recorte de cada uma —
estão no cronograma de fatias, em `openspec/`; o requisito, a decisão e o porquê de cada fatia,
no `proposal.md` e no `design.md` dela; decisão nova tomada durante a implementação, em
`docs/09-topicos-em-aberto-e-sugestoes.md` §1; o que falta de cada PRD, na §14 do próprio PRD.
Nenhum dos quatro é repetido aqui.
...
| [PRD-13](prd-13-area-dos-responsaveis.md) | Área dos pais e responsáveis           | App 07    | 4    | implementado |
| [PRD-03](prd-03-vitrine-publica.md)       | Vitrine pública                        | App 06    | 4    | aprovado     |
| [PRD-14](prd-14-area-do-apoiador.md)      | Área do Apoiador                       | App 08    | 5    | implementado |
