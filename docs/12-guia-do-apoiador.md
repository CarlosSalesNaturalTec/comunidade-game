...
ajudar os colegas e registrar dados do próprio território gera pontos, poderes e
reconhecimento.
...
- **Valores inegociáveis:** humanismo, educação transformadora, causa antirracista, combate à
  ...
  letramento sobre a crise ambiental e protagonismo dos Guerreiros e Guerreiras.
...
- **O ciclo de evolução positiva**: o que a plataforma produz não sai da comunidade — volta
...
- **Protagonismo dos Guerreiros e Guerreiras**: o apoio não financia assistência, financia
  **autoria** — criações originais com crédito público na vitrine e Guerreiros e Guerreiras que
  participam da evolução da própria plataforma.
...
- **Duas modalidades:** **aberto** (a todos os Guerreiros e Guerreiras da trilha, ninguém é
  barrado de disputar) e **direcionado** (a um Guerreiro(a) específico, único que pode receber
  a recompensa, mediante justificativa registrada do vínculo — por exemplo, um parente próximo
  — e aprovação de Admin).
- **Salvaguarda inegociável:** **nenhum contato direto entre Apoiador e Guerreiro(a)**.
