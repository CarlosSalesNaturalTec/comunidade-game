...
| Canal de propostas do Mestre                   | Jogador (App 05), responsável (App 07) e Apoiador (App 08) já têm sua área de propostas; falta definir por onde o **Mestre** registra as dele — a App 03 é a candidata natural                                                                                                                                                                                                           |
| Acesso à App 08                                | Forma de autenticação do Apoiador e se uma instituição pode ter mais de um usuário no mesmo cadastro                                                                                                                                                                                                                                                                                     |
