...
| **Guarda dos dados bancários de Mestres e Admins** | O cadastro de chave PIX, banco e favorecido na App 09 traz dado financeiro de adulto para a plataforma: falta definir criptografia, quem acessa, retenção e o que acontece quando a pessoa deixa o projeto                                                 |
...
| Acesso às Apps 08 e 09                             | Forma de autenticação de Apoiador e de Mestre, se uma instituição pode ter mais de um usuário no mesmo cadastro e quais permissões o Mestre mantém na App 03                                                                                               |
