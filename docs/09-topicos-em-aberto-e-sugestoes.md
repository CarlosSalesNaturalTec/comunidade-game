...
| Valoração e guarda do acervo e dos kits        | Como o acervo, os 30 kits MDF e as 50 camisas entram no livro-razão (valor de mercado, simbólico ou contagem física) e quem responde pela guarda em cada ponto de apoio — é esse valor que define a conversão em moedas                                    |
...
| Monetização dos dados — termo e pagamento      | O rateio já é 50% / 50%, com a parte do jogador paga ao responsável legal. Falta a **redação da regra no termo** assinado, a base legal e a periodicidade do pagamento                                                                                     |
