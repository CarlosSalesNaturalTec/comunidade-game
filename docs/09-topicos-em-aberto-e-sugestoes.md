...
| **Criação original — pontos e badge de autoria** | **Decidido:** toda trilha desemboca em criação original do jogador ou da equipe, com autoria creditada e vitrine ([02 §4](02-conceito-do-jogo-e-gamificacao.md#criações-originais-dos-jogadores)); a criação pontua e rende badge de autoria ([11 §5](11-modelo-de-gamificacao.md#5-motor-de-pontuação), [11 §7](11-modelo-de-gamificacao.md#7-badges)). Falta definir: **valor em pontos**, critérios de validação pelo Mestre e formato da exposição no portfólio da vitrine. |
| **Canal de sugestões do jogador (App 05)** | **Decidido:** o jogador registra sugestões de melhoria para atividades, trilhas e para a própria plataforma pela Área do Jogador, com fila de avaliação na gestão ([03 §7](03-plataforma-e-arquitetura.md#7-app-05--área-do-jogador)). Falta definir: formato do registro (texto/áudio), se sugestão adotada pontua, e prazo/forma do retorno a quem sugeriu. |
| **Nota de transparência sobre IA na vitrine** | **Decidido:** a vitrine publica a declaração de que os artefatos da plataforma são construídos com auxílio de IA, sob idealização e direção humanas ([01 §7](01-visao-valores-e-proposito.md#como-os-artefatos-são-construídos--ia-como-alavanca), [03 §8](03-plataforma-e-arquitetura.md#8-app-06--vitrine-pública-apresentação-da-plataforma)). Falta definir: texto final e localização exata da nota, e a conexão com a linha "Licenças" quanto a conteúdo gerado com auxílio de IA. |
