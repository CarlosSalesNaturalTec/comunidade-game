...
- **Calibração do limiar**: o limiar de comparação é medido **no aparelho do encontro**, pela
  própria App 01, sob o **mesmo termo assinado** que a captura exige. A medição compara
  descritores no aparelho, guarda **um** de referência por vez, descarta cada captura comparada
  no mesmo ato e **nada envia ao núcleo**: o que se registra é a distância, nunca o descritor.
