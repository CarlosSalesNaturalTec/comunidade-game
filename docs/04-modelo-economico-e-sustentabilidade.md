...
### Custos de construção e conta de _cloud_
...
**A conta de _cloud_ entra sempre por fatura**, também depois de o livro-razão existir: nenhuma
aplicação mede, conta ou lança consumo por ato — nem o armazenamento do que o Mestre envia, nem
o uso dos modelos de IA. A fatura do período vira aporte por absorção, pela mesma regra acima.
...
quem o concluir. **O Mestre também propõe desafio extra**, pela mesma mecânica.

**Como funciona no ciclo:**

1. O **Apoiador ou o Mestre** propõe o desafio, vinculado a uma **trilha em andamento**,
   declara se é **presencial ou on-line** e indica a recompensa e **em que quantidade**.
2. O **Mestre da trilha valida** — o desafio precisa fazer sentido pedagógico na missão em que
   os Guerreiros e Guerreiras estão. **Dispensada quando o proponente é o próprio Mestre
   autor da trilha**; outro Mestre proponente passa pela validação como qualquer um.
3. Um **Admin aprova** (ou não) a publicação, conferindo o lastro da recompensa.
...
| Questão                          | Definição                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Pontos**                       | O desafio extra vale **pontos além da recompensa**, computados **isoladamente como pontos extras** — não se misturam à pontuação regular da trilha —, **até 10 por desafio**. O teto existe porque ponto extra compra recompensa avulsa (documento 02 §8.2): sem ele, quem define o valor do desafio definiria a oferta de moeda                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Quem propõe**                  | **Apoiador ou Mestre.** O Mestre propõe pela mesma mecânica e custeia como qualquer proponente                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Custeio da recompensa**        | **Absorção do proponente** ou **saldo de recurso já existente na plataforma**, vindo de aporte homologado. Nos dois casos a recompensa é **reservada na publicação** e baixada na entrega; sem saldo, o desafio não publica                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Formato**                      | **Presencial ou on-line**, declarado pelo proponente — o desafio extra vale tanto no encontro quanto entre encontros                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| **Encerramento**                 | Ato do **Admin na gestão** que fecha o desafio publicado e devolve ao ponto de apoio a recompensa ainda não entregue; o desafio deixa de receber conclusão nova. A vigência declarada, sozinha, **não encerra** — só este ato (decisão do fundador, 2026-09-02)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
- **A curadoria do Mestre é condição, não formalidade**: desafio extra sem validação pedagógica
  vira publicidade dentro de uma trilha infantil, o que o projeto não admite. A dispensa vale
  **só** para o Mestre autor da própria trilha, que é quem faria a validação — e nunca dispensa
  a aprovação do Admin.
