...
O projeto será implantado **inicialmente em uma comunidade próxima à residência do fundador**
(piloto) e deve servir de **modelo de implantação para qualquer comunidade do país**.
...
App acessível pelo celular), justamente porque o público-alvo tem acesso desigual a
equipamentos.
...
1. **Tombamento e ficha de vida.** Cada exemplar recebe número de tombo e registro na gestão:
   ...
   apoio** — o mesmo número pode existir em pontos de apoio diferentes. **A partir do Ciclo
   02**, o Guerreiro(a) vê na Área do Guerreiro(a) **quais Guerreiros e Guerreiras cuidaram
   daquele livro antes** — o exemplar carrega uma linhagem, e ninguém quer ser o elo que
   quebrou a corrente; no Ciclo 01 a ficha de vida existe só na gestão.
...
- **Os momentos coletivos são âncoras, não interrupções arbitrárias.** Convém concentrá-los na
  segunda metade do encontro, quando a maior parte da turma já chegou.
...
- **Multiplicadores** formados abrem novos cursos em novas comunidades — é o mecanismo de
  escala do projeto.
- **Admissão como Mestre na plataforma** exige, sem exceção: cadastro por um Admin e
  habilidade comprovada por materiais ou artefatos publicados na plataforma. O mesmo vale para
  **Apoiadores**.
- **Estagiários** locais recebem ajuda de custo — porta de entrada remunerada para jovens da
  própria comunidade.
...
3. **Comunidades Virtuais** como unidade de organização — cada território com sua base de
   dados.
4. **Modelo econômico com lastro local**: atividades só acontecem com recursos providos por
   mestres e apoiadores da própria rede.
5. **Trilhas prontas** para o primeiro ciclo: Robô Educa e Batalha de Laser.
6. **Multiplicadores** formados pela gamificação.

**[Proposta]** Criar um **"Kit de Implantação"** (playbook): requisitos mínimos (ponto de
apoio, 1 mestre, 1 apoiador), checklist legal (termos de consentimento, LGPD/ECA), materiais de
divulgação editáveis e orçamento-modelo de um primeiro ciclo. É o documento que transforma
...
| -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| 0 — Fundação                           | Código de conduta (versão prévia, a co-criar no 1º encontro), termos de consentimento, identidade visual (documento 15; falta o logotipo), comunidade piloto definida | —                                             |
...
| 6 — Economia visível                   | Livro-razão público em moedas, Poder Sustentador, relatórios de transparência e **App 08** — Área do Apoiador                                                         | Fase 3                                        |
